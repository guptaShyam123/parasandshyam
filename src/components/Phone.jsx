...
<div style={{display:'flex' , marginLeft:'100px' , fontWeight:'bolder' , fontFamily:'Poppins'}}>
 <div style={{marginLeft:'20px'}}>
   ...
   <div style={{marginLeft:'800px' , height:'450px' , width:'300px' ,marginTop:'-600px'}} >
   
   <img style={{height:'650px' , marginTop:'-10px'}}   src={Phones} />
   <p style={{ marginTop:'-380px' , marginLeft:'120px' , fontSize:'36px' , color:'#00BEE3' ,  fontWeight:'600'}}>KATON</p>
   <p style={{ marginTop:'-40px' , marginLeft:'125px' , fontSize:'10px' , color:'#00BEE3' ,  }}>360-Degree Learning Hub</p>
   </div>
   </div>
